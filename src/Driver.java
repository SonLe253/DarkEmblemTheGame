...
public class Driver {
	...
	public static void main(String[] args) {
		...
		// Locations the game
		Location Sacae = new Location("Sacae", "Vast grasslands, home to various nomad tribes. You wake up here, having an amnesia."
				+ "\n" + "\t" + "Added some extra items to the first location to test the unlock function with locked container and locked item, normally it will appear later in the game. Normally, the key4 can be obtained at Location #7, key3 at Location#5 and Armorslayer in Location#9","1.mp3");
		...
		Nabata.addDirection("south", Missur);
		Nabata.addDirection("south-west", Kafti);
		...
		//Added these items to the first location to test the unlock function with locked container and locked item, normally it will appear later in the game. Normally, the key4 can be obtained at Location #7, key3 at Location#5 and Armorslayer in Location#9//
		Sacae.addItems(key4);
		Sacae.addItems(hiddenloc9a);
		Sacae.addItems(key3);
